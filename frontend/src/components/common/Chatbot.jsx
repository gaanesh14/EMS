...
const Chatbot = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const errorEntry = { sender: 'bot', text: 'Sorry, I am currently unable to connect to the AI service.' };
                ...
                <div className="h-[60vh] overflow-y-auto p-4 space-y-4">
                    {messages.length === 0 && (
                        <div className="text-center text-gray-500 mt-10">
                            <p>Ask me anything about employees, departments, or system status!</p>
                            <p className="text-sm italic mt-2">I have access to the current counts of employees and departments.</p>
                        </div>
                    )}
